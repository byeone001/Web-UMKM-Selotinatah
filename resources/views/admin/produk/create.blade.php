                ...
                <div x-data="{ photoPreview: null, fileName: '' }">
                    ...
                    <div class="upload-zone" @click="$refs.fotoInput.click()" @dragover.prevent @drop.prevent="
                        ...
                        <label class="mt-4 block text-left text-xs font-bold text-slate-600" @click.stop>
                            Foto/Video tambahan gallery (maks. 6, video maks 50 MB)
                        ...
                        <template x-if="photoPreview">
                            <div class="flex flex-col items-center py-2" @click.stop>
                                <img :src="photoPreview"
                                    class="w-36 h-36 rounded-2xl object-cover border-2 border-sapphire-400 shadow-md mb-2">
                        ...
                        <template x-if="!photoPreview">
                            <div class="flex flex-col items-center py-4 text-center">
                                <div
                                    class="w-14 h-14 rounded-2xl bg-sapphire-50 text-sapphire-600 flex items-center justify-center mb-3 shadow-sm border border-sapphire-100">
                                    <svg class="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                                    </svg>
                                </div>
                                <p class="text-sm font-bold text-slate-700">Pilih Berkas Foto Produk atau Tarik ke Sini
                                </p>
