    ...
    <div class="space-y-6">
        ...
        <div class="page-header">
            <div>
                ...
                <p class="page-subtitle">Perbarui informasi UMKM: <span
                        class="font-bold text-emerald-600">{{ $umkm->nama_umkm }}</span></p>
            </div>
            ...
            <form action="{{ route('admin.umkm.update', $umkm->id_umkm) }}" method="POST" enctype="multipart/form-data"
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="tel" name="kontak" value="{{ old('kontak', $umkm->kontak) }}" required
                            inputmode="numeric" autocomplete="tel" placeholder="08xxx atau 628xxx"
                ...
                <div>
                    ...
                    <textarea name="alamat" rows="2" placeholder="Alamat lengkap UMKM..."
                ...
                <div>
                    ...
                    <textarea name="deskripsi" rows="3" placeholder="Deskripsi UMKM..."
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="url" name="link_lokasi" value="{{ old('link_lokasi', $umkm->link_lokasi) }}"
                ...
                <div x-data="{ photoPreview: null, fileName: '' }">
                    <label class="form-label">Foto UMKM <span class="text-slate-400 font-normal normal-case">(kosongkan
                        ...
                        <div class="mb-3 p-4 bg-slate-50 rounded-2xl border border-slate-200 flex items-center justify-between"
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-[11px] text-slate-400 mt-0.5">Biarkan kosong jika tetap menggunakan foto
                                        ini</p>
                                </div>
                            </div>
                    ...
                    <div class="upload-zone" @click="$refs.fotoInput.click()" @dragover.prevent @drop.prevent="
                        ...
                        <template x-if="photoPreview">
                            <div class="flex flex-col items-center py-2" @click.stop>
                                <img :src="photoPreview"
                                    class="w-32 h-32 rounded-2xl object-cover border-2 border-amber-400 shadow-md mb-2">
                                <p class="text-xs font-bold text-slate-700 max-w-xs truncate" x-text="fileName"></p>
                                <p class="text-xs text-amber-600 font-bold mt-1">✓ Foto baru siap diupload untuk
                                    menggantikan foto lama</p>
                        ...
                        <template x-if="!photoPreview">
                            <div class="flex flex-col items-center py-4 text-center">
                                <div
                                    class="w-14 h-14 rounded-2xl bg-amber-50 text-amber-600 flex items-center justify-center mb-3 shadow-sm border border-amber-100">
                                ...
                                <p class="text-xs text-slate-400 mt-1 mb-3">Tarik foto ke sini atau telusuri berkas
