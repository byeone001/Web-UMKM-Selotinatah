            ...
            <form action="{{ route('admin.umkm.store') }}" method="POST" enctype="multipart/form-data"
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="kontak" value="{{ old('kontak') }}"
                               placeholder="Format: 08xxx atau 628xxx"
                               class="form-input pl-10">
                    </div>
                    <p class="mt-1.5 text-xs text-slate-400">Format: 08123456789 atau 628123456789 (untuk link WhatsApp)</p>
                </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="link_lokasi" value="{{ old('link_lokasi') }}"
                    ...
                    <div class="upload-zone"
                        ...
                        <template x-if="photoPreview">
                            <div class="flex flex-col items-center py-2" @click.stop>
                                <img :src="photoPreview" class="w-32 h-32 rounded-2xl object-cover border-2 border-emerald-400 shadow-md mb-2">
                        ...
                        <template x-if="!photoPreview">
                            <div class="flex flex-col items-center py-4 text-center">
                                <div class="w-14 h-14 rounded-2xl bg-emerald-50 text-emerald-600 flex items-center justify-center mb-3 shadow-sm border border-emerald-100">
