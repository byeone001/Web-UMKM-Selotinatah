...
<div class="min-h-screen grid lg:grid-cols-2">
    ...
    <div class="auth-left-panel">
        ...
        <div class="absolute bottom-0 left-0 w-96 h-96 bg-sapphire-600/20 rounded-full translate-y-1/2 -translate-x-1/3 pointer-events-none"></div>
        <div class="absolute top-1/2 left-1/2 w-64 h-64 bg-teal-500/10 rounded-full -translate-x-1/2 -translate-y-1/2 blur-2xl pointer-events-none"></div>
        ...
        <div class="relative z-10 p-10 flex-1 flex flex-col justify-between">
            ...
            <div class="space-y-5">
                <div>
                    <p class="text-emerald-300 text-sm font-semibold uppercase tracking-widest mb-2">🌿 Panel Administrasi</p>
                    ...
                    <p class="text-emerald-100/80 text-sm leading-relaxed mt-4 max-w-sm">
                        Kelola data UMKM, produk anyaman bambu, dan laporan desa Selotinatah dari satu panel yang terintegrasi.
                    </p>
                </div>
            ...
            <div class="bg-white/10 backdrop-blur-sm rounded-2xl p-5 border border-white/20">
                ...
                <p class="text-white/90 text-sm font-medium italic leading-relaxed">
                    "Anyaman bambu, warisan leluhur yang menjadi kebanggaan dan penghidup masyarakat Desa Selotinatah."
                </p>
    ...
    <div class="auth-right-panel">
        <div class="w-full max-w-md">
            ...
            <div class="lg:hidden text-center mb-8">
                <div class="inline-flex items-center gap-3 bg-emerald-50 px-4 py-2.5 rounded-2xl border border-emerald-200 mb-2">
            ...
            <div class="bg-white rounded-3xl shadow-xl border border-slate-200/80 p-8 animate-slide-up">
                ...
                <!-- Card Header -->
                <div class="mb-7">
                    <div class="w-12 h-12 rounded-2xl bg-gradient-to-br from-emerald-500 to-teal-600 flex items-center justify-center mb-4 shadow-lg shadow-emerald-500/30">
                        <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"/>
                        </svg>
                    </div>
                    <h2 class="text-2xl font-black text-slate-900">Masuk ke Panel</h2>
                    <p class="text-sm text-slate-500 mt-1">Masukkan kredensial Anda untuk mengakses panel administrasi.</p>
                </div>
                ...
                <form method="POST" action="{{ route('login') }}" class="space-y-5">
                    ...
                    <div>
                        <div class="flex items-center justify-between mb-2">
                            ...
                            @if (Route::has('password.request'))
                                <a href="{{ route('password.request') }}" class="text-xs text-emerald-600 hover:text-emerald-700 font-semibold transition-colors">
                                    Lupa password?
                                </a>
                            @endif
                        </div>
                    ...
                    <div class="flex items-center gap-2.5">
                        ...
                        <label for="remember_me" class="text-sm text-slate-600 cursor-pointer">Ingat saya di perangkat ini</label>
                    </div>
                ...
                <div class="mt-6 pt-5 border-t border-slate-100 text-center">
                    <a href="/" class="inline-flex items-center gap-1.5 text-xs font-semibold text-slate-500 hover:text-emerald-600 transition-colors">
