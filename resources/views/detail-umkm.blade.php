...
<head>
    ...
    <meta name="description"
        content="Profil UMKM {{ $umkm->nama_umkm }} - Desa Selotinatah, Kecamatan Ngariboyo, Magetan">
...
<body
        ...
        <div
            ...
            <div class="flex-shrink-0">
                <a href="{{ route('home') }}#umkm"
                    ...
                    <span class="hidden sm:inline">Kembali ke Direktori UMKM</span>
                    <span class="sm:hidden">Direktori</span>
                </a>
            </div>
        </div>
    </header>
    ...
    <!-- MAIN DETAIL CONTENT -->
    <main class="flex-1 max-w-6xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-10">
        ...
        <nav aria-label="Breadcrumb"
            ...
            <span>/</span>
            <span class="text-slate-800 font-semibold truncate min-w-0">{{ $umkm->nama_umkm }}</span>
        </nav>
            ...
            <div class="p-5 sm:p-8">
                <div class="flex flex-col md:flex-row gap-6 items-start -mt-16 sm:-mt-20">
                    ...
                    <div class="relative flex-shrink-0">
                        ...
                        @else
                            <div
                                class="w-28 h-28 sm:w-32 sm:h-32 rounded-2xl bg-gradient-to-br from-emerald-500 to-teal-600 flex items-center justify-center text-white font-black text-4xl border-4 border-white shadow-xl weave-bg">
                    ...
                    <div class="flex-1 space-y-3">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-2 text-xs text-slate-600 pt-1">
                            ...
                            <p class="flex items-center gap-1.5 sm:col-span-2">
                                ...
                                {{ $umkm->alamat ?? 'Desa Selotinatah, Kec. Ngariboyo, Kab. Magetan' }}
                            </p>
                        </div>
                        ...
                        <div class="pt-4 flex flex-col sm:flex-row gap-3">
                            @if($linkWa)
                                <a href="{{ $linkWa }}" target="_blank" rel="noopener noreferrer"
                                    class="btn-primary w-full sm:w-auto justify-center text-xs inline-flex items-center gap-2">
                            ...
                            @else
                                <span class="text-xs font-semibold text-slate-500">Nomor WhatsApp belum tersedia</span>
                            @endif

                            @if($umkm->hasValidLocationLink())
                                <a href="{{ $umkm->link_lokasi }}" target="_blank" rel="noopener noreferrer"
                                    class="btn-secondary w-full sm:w-auto justify-center text-xs inline-flex items-center gap-2">
                                    <svg class="w-4 h-4 text-sapphire-600" fill="none" stroke="currentColor"
                                        viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <div class="mb-6 flex items-center justify-between">
            <div>
                ...
                <h2 class="text-2xl font-black text-slate-900 tracking-tight mt-0.5">Produk dari {{ $umkm->nama_umkm }}
                </h2>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
                ...
                <div
                    ...
                    <div>
                        ...
                        <div class="relative h-44 bg-slate-100 overflow-hidden">
                            @if($p->foto)
                                <img src="{{ asset('storage/' . $p->foto) }}" alt="{{ $p->nama_produk }}" loading="lazy"
                                    decoding="async" onerror="this.classList.add('hidden')"
                        ...
                        <div class="p-5">
                            ...
                            <h3
                                class="font-bold text-slate-900 text-sm group-hover:text-emerald-600 transition-colors line-clamp-1 mb-1">
                                {{ $p->nama_produk }}
                            </h3>
            ...
            @empty
                <div class="col-span-full bg-white p-12 rounded-3xl border border-dashed border-slate-300 text-center">
                    ...
                    <p class="text-xs text-slate-400 mt-1">Silakan hubungi pemilik usaha melalui WhatsApp untuk informasi
                        lebih lanjut.</p>
                </div>
            @endforelse
        </div>
